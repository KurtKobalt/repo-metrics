...
export function CodingByDayOfWeek({ data, weekCount }: Props) {
  ...
  return (
    <ChartContainer title="Commits by Day of Week" isEmpty={data.length === 0}>
      ...
      <ResponsiveContainer width="100%" height={280}>
        <BarChart data={chartData}>
          ...
          <Bar dataKey="commits" fill={COMMITS_COLOR} radius={[4, 4, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
